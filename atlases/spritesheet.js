...
SpriteSheetClass = Class.extend({
	...
	parseAtlasDefinition: function (atlasJSON) {
        ...
        //
		// YOUR CODE HERE
        parsedJSON = JSON.parse(atlasJSON);
        ...
        for (var i in parsedJSON['frames']) {
            name = i;
            x = parsedJSON['frames'][i]['frame']['x'];
            y = parsedJSON['frames'][i]['frame']['y'];
            w = parsedJSON['frames'][i]['frame']['w'];
            h = parsedJSON['frames'][i]['frame']['h'];
            cx = -w/2;
            cy = -h/2;
